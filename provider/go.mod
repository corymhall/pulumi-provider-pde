module github.com/corymhall/pulumi-provider-pde/provider

go 1.20

require (
	github.com/blang/semver v3.5.1+incompatible
	github.com/corymhall/pulumi-provider-pde/sdk v0.0.0-20230908150318-973e1ffd761a
	github.com/google/go-github/v55 v55.0.0
	github.com/pulumi/pulumi-command/provider v0.0.0-20230906152501-666e0f43906e
